        ...
        <thead>
          <tr className="bg-gray-200 text-left">
            ...
            <th onClick={() => handleSort("name")} className="cursor-pointer">
              Spieler {getArrow("name")}
            </th>
            <th onClick={() => handleSort("birthday")} className="cursor-pointer">
              Geburtstag {getArrow("birthday")}
            </th>
            <th onClick={() => handleSort("age")} className="cursor-pointer">
              Alter {getArrow("age")}
            </th>
            <th onClick={() => handleSort("lastValue")} className="cursor-pointer">
              Vormonat {getArrow("lastValue")}
            </th>
            <th onClick={() => handleSort("currentValue")} className="cursor-pointer">
              Aktuell {getArrow("currentValue")}
            </th>
            <th onClick={() => handleSort("trend")} className="cursor-pointer">
              Trend {getArrow("trend")}
            </th>
            <th>Aktion</th>
          </tr>
        </thead>
